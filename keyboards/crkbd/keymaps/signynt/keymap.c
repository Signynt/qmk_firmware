...
//define layers
enum layers {BASE, MEDR, NAVR, NSSL, NSL, FUNL};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_split_3x6_3(
    ...
    KC_LCTL,              KC_Z,              KC_X,              KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           KC_DOT,            KC_SLSH,           KC_LCTL,
                                                                KC_ESC,            LT(NAVR, KC_SPC),  LT(MEDR, KC_TAB),  LT(NSSL, KC_ENT),  LT(NSL, KC_BSPC),  LT(FUNL, KC_DEL)

  ),

//layers
  [NAVR] = LAYOUT_split_3x6_3(
    KC_LALT,              KC_RST,            KC_NO,             KC_NO,              G(KC_TAB),        KC_NO,             C(S(KC_Z)),        C(A(KC_LEFT)),     C(KC_X),           C(KC_C),           C(A(KC_RGHT)),     KC_LALT,
    ...
    KC_LCTL,              G(S(C(KC_F1))),    G(S(C(KC_F3))),    G(S(C(KC_F4))),     G(S(C(KC_F2))),   KC_NO,             KC_INS,            KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            KC_LCTL,
                                                                KC_NO,              KC_NO,            KC_ENT,            KC_ENT,            KC_BSPC,           KC_DEL
  ),
  ...
  [FUNL] = LAYOUT_split_3x6_3(
    ...
    KC_LCTL,              KC_F10,            KC_F1,             KC_F2,              KC_F3,            KC_PAUS,           KC_F13,            KC_NO,             KC_NO,             KC_NO,             KC_NO,             KC_LCTL,
                                                                KC_APP,             KC_SPC,           KC_UNDS,           KC_UNDS,           KC_NO,             KC_NO
  ),
  [NSL] = LAYOUT_split_3x6_3(
    ...
    KC_LCTL,              KC_GRV,            KC_1,              KC_2,               KC_3,             KC_PLUS,           KC_TILD,           KC_EXLM,           KC_COMM,           KC_DOT,            KC_SLSH,           KC_LCTL,
                                                                KC_UNDS,            KC_0,             KC_MINS,           KC_SPC,            KC_NO,             KC_NO
  ),
  [NSSL] = LAYOUT_split_3x6_3(
    ...
    KC_LCTL,              KC_TILD,           KC_EXLM,           KC_AT,              KC_HASH,          KC_PIPE,           KC_NO,             KC_WH_L,           KC_WH_D,           KC_WH_U,           KC_WH_R,           KC_LCTL,
                                                                KC_GT,              KC_SPC,           KC_NO,             KC_BTN1,           KC_BTN3,           KC_BTN2
  ),
};
