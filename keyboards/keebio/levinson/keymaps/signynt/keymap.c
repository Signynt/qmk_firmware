// qmk flash -kb keebio/levinson -km signynt
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_ortho_4x12(
    ...
    G(A(S(KC_H))),        KC_TD(TD_SCREEN),  KC_ESC,            LT(MEDR, KC_TAB),  LT(NAVR, KC_SPC),  LT(NSSL, KC_ENT), LT(NSSL, KC_ENT),   LT(NSL, KC_BSPC),  LT(FUNL, KC_DEL),  KC_LGUI,           KC_TD(TD_MEDIA),   KC_TD(TD_SPACE)
  ),
...
//layers
  [NAVR] = LAYOUT_ortho_4x12(
    ...
    TG(GAME),             KC_NO,             KC_NO,             KC_NO,              KC_NO,            KC_ENT,            KC_ENT,            KC_BSPC,           KC_DEL,            KC_NO,             THROW_L,           THROW_R
  ),
