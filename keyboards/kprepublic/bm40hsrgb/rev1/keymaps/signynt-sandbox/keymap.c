// qmk flash -kb bm40hsrgb -km signynt-test
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_planck_mit(
    ...
    KC_LSFT,              UML_A,             UML_S,             UMLG_S,            UC(0x00E4),        UC(0x00DF),        UC(0x1E9E),              KC_J,              KC_K,              KC_L,              KC_QUOT,           KC_LSFT,
